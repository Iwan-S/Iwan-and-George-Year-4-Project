...
def define_input(define_io, define_fit, define_output, define_plots, define_intpol):
    ...
    define_io["outputpath"] = os.path.join("output", "Output")
    ...
    define_io["asciifile"] = os.path.join("data/Input", "Gaia.txt")
    define_io["params"] = (
        "starid",
        "Teff",
        "Teff_err",
    ...
    define_fit["fitparams"] = ("Teff", "FeH", "logg", "parallax", "G_GAIA")
    ...
    define_output["outputfile"] = "GaiaResults.ascii"

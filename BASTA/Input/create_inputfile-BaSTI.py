...
def define_input(define_io, define_fit, define_output, define_plots, define_intpol):
    ...
    xmlfilename = "InputGaiaBaSTI.xml"
    ...
    define_io["gridfile"] = os.path.join(BASTADIR, "grids", "Garstec_AS09_barbieMS.hdf5")

    # Where to store the output of the BASTA run
    define_io["outputpath"] = os.path.join("output/Output", "GaiaBaSTI")
    ...
    define_io["asciifile"] = os.path.join("data/Input", "GaiaBaSTI.txt")
    define_io["params"] = (
        "starid",
        "Teff",
        "Teff_err",
    ...
    define_fit["fitparams"] = ("Teff", "FeH", "logg", "parallax")
    ...
    define_fit["priors"] = {"Teff": {"abstol": "600"}}
    ...
    define_output["outparams"] = ("Teff", "FeH", "radPhot", "massfin", "age", "numax", "dnuscal")
    ...
    define_output["outputfile"] = "GaiaBaSTIResults.ascii"
